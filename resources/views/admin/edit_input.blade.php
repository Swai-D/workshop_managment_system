...
<form class="form-horizontal form-material"  action="/{{$id->id}}" method="POST">
  ...
  @method('PATCH')
        ...
        <div class="form-group">
            ...
            <div class="col-md-12">
                <input type="text" class="form-control form-control-line" placeholder="eg.Monitor" name="type_of_machine" value="{{ old('type_of_machine') ?? $id -> type_of_machine }}" required autocomplete="type_of_machine" autofocus />
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-12">
                <input type="text" placeholder="eg.Kinondoni"class="form-control form-control-line" name="location" value="{{ old('location') ?? $id -> location}}" required autocomplete="location" autofocus />
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-12">
                <input type="text" placeholder="eg.Mr.Davis"class="form-control form-control-line" name="brought_by" value="{{ old('brought_by') ?? $id -> brought_by }}" required autocomplete="brought_by" autofocus />
            </div>
 ...
 @csrf
    ...
    <form class="form-horizontal form-material" action="/output_edit" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="col-md-12">
                <input type="number" class="form-control form-control-line" name="item_id" value="{{ old('item_id') ?? $id -> item_id }}" required autocomplete="item_id" autofocus />
            </div>
