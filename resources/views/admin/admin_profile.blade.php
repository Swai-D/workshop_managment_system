                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" enctype="multipart/form-data" action="/update_profile" method="POST">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Johnathan Doe"
                                            class="form-control form-control-line" value="{{old('name') ?? Auth::user()->name}}" name="name"></div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="password" class="form-control form-control-line" value="{{old('password') ?? Auth::user()->password}}" name="password">
                                    </div>
                                </div>
